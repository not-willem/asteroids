...
if (!keys_pressed['d'] && !keys_pressed['a']) {if (speed_x > 0) {speed_x = speed_x - 5;}else{speed_x = 0;}}
if (!keys_pressed['w'] && !keys_pressed['s']) {if (speed_y > 0) {speed_y = speed_y - 5;}else{speed_x = 0;}}
});
